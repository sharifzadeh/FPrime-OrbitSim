...
#include <OrbitSimDeployment/Top/OrbitSimDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    OrbitSimDeployment::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    OrbitSimDeployment::TopologyState inputs;
    ...
    OrbitSimDeployment::setupTopology(inputs);
    OrbitSimDeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    OrbitSimDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
