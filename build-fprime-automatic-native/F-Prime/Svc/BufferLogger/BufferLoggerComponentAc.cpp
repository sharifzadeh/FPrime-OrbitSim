...
namespace Svc {
    ...
    )
  {
    ...
    // Serialize message ID
    _status = msg.serializeFrom(
      static_cast<FwEnumStoreType>(COMIN_COM)
    );
    FW_ASSERT(
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serializeFrom(static_cast<FwEnumStoreType>(CMD_BL_OPENFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serializeFrom(static_cast<FwEnumStoreType>(CMD_BL_CLOSEFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serializeFrom(static_cast<FwEnumStoreType>(CMD_BL_SETLOGGING));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serializeFrom(static_cast<FwEnumStoreType>(CMD_BL_FLUSHFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
  ...
  void BufferLoggerComponentBase ::
    log_DIAGNOSTIC_BL_LogFileClosed(const Fw::StringBase& file) const
  {
    // Get the time
    Fw::Time _logTime;
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = file.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
      _status = _logBuff.serializeFrom(errornum);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
  ...
  void BufferLoggerComponentBase ::
    log_WARNING_HI_BL_LogFileValidationError(
        const Fw::StringBase& validationFile,
        U32 status
    ) const
  {
    // Get the time
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = validationFile.serializeTo(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
  ...
  void BufferLoggerComponentBase ::
    log_ACTIVITY_LO_BL_Activated() const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void BufferLoggerComponentBase ::
    log_ACTIVITY_LO_BL_Deactivated() const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void BufferLoggerComponentBase ::
    log_WARNING_HI_BL_NoLogFileOpenInitError() const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
    ...
    doDispatch()
  {
    ...
    if (_msgType == BUFFERLOGGER_COMPONENT_EXIT) {
    ...
    switch (_msgType) {
      ...
      case CMD_BL_OPENFILE: {
        ...
        _deserStatus = args.deserializeTo(file);
      ...
      case CMD_BL_CLOSEFILE: {
        ...
        // Call handler function
        this->BL_CloseFile_cmdHandler(_opCode, _cmdSeq);
      ...
      case CMD_BL_SETLOGGING: {
        ...
        _deserStatus = args.deserializeTo(state);
        if (_deserStatus != Fw::FW_SERIALIZE_OK) {
          if (this->m_cmdResponseOut_OutputPort[0].isConnected()) {
            this->cmdResponse_out(
                _opCode,
      ...
      case CMD_BL_FLUSHFILE: {
        ...
        // Call handler function
        this->BL_FlushFile_cmdHandler(_opCode, _cmdSeq);
