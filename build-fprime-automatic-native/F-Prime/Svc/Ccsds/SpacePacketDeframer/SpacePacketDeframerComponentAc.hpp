      ...
      public Fw::PassiveComponentBase
    {
      ...
      protected:
        ...
        enum {
          ...
          NUM_ERRORNOTIFY_OUTPUT_PORTS = 1,
      ...
      public:
        ...
        void set_errorNotify_OutputPort(
            FwIndexType portNum, //!< The port number
            Svc::Ccsds::InputErrorNotifyPort* port //!< The input port
        );
      ...
      protected:
        ...
        //! Get the number of errorNotify output ports
        //!
        //! \return The number of errorNotify output ports
        static constexpr FwIndexType getNum_errorNotify_OutputPorts() {
          return NUM_ERRORNOTIFY_OUTPUT_PORTS;
        }
        ...
        static constexpr FwIndexType getNum_validateApidSeqCount_OutputPorts() {
          return NUM_VALIDATEAPIDSEQCOUNT_OUTPUT_PORTS;
        }
      ...
      protected:
        ...
        //! Check whether port errorNotify is connected
        //!
        //! \return Whether port errorNotify is connected
        bool isConnected_errorNotify_OutputPort(
            FwIndexType portNum //!< The port number
        );
      ...
      private:
        ...
        //! Output port errorNotify
        Svc::Ccsds::OutputErrorNotifyPort m_errorNotify_OutputPort[NUM_ERRORNOTIFY_OUTPUT_PORTS];
