    ...
    public Fw::ActiveComponentBase
  {
    ...
    protected:
      ...
      enum {
        ...
        EVENTID_COMMANDDROPPEDQUEUEOVERFLOW = 0xb, //!< This log event reports the Command Sequence Buffer port queue has overflowed.
      };

      //! Event throttle values: sets initial value of countdown variables
      enum {
        EVENTID_COMMANDDROPPEDQUEUEOVERFLOW_THROTTLE = 5, //!< Throttle reset count for CommandDroppedQueueOverflow
      };
      ...
      enum {
        ...
        CHANNELID_COMMANDSDROPPED = 0x2, //!< Channel ID for CommandsDropped
      };
    ...
    protected:
      ...
      static constexpr FwIndexType getNum_compCmdReg_InputPorts() {
        return NUM_COMPCMDREG_INPUT_PORTS;
      }
      ...
      static constexpr FwIndexType getNum_compCmdStat_InputPorts() {
        return NUM_COMPCMDSTAT_INPUT_PORTS;
      }
      ...
      static constexpr FwIndexType getNum_seqCmdBuff_InputPorts() {
        return NUM_SEQCMDBUFF_INPUT_PORTS;
      }
    ...
    protected:
      ...
      static constexpr FwIndexType getNum_compCmdSend_OutputPorts() {
        return NUM_COMPCMDSEND_OUTPUT_PORTS;
      }
      ...
      static constexpr FwIndexType getNum_seqCmdStatus_OutputPorts() {
        return NUM_SEQCMDSTATUS_OUTPUT_PORTS;
      }
    ...
    protected:
      ...
      virtual void seqCmdBuff_overflowHook(
          FwIndexType portNum, //!< The port number
          Fw::ComBuffer& data, //!< Buffer containing packet data
          U32 context //!< Call context value; meaning chosen by user
      ) = 0;
    ...
    protected:
      ...
      void log_WARNING_HI_CommandDroppedQueueOverflow(
          FwOpcodeType OpCode, //!< The command opcode dropped
          U32 Context //!< The call order
      );
    ...
    private:
      ...
      //! Throttle for CommandDroppedQueueOverflow
      std::atomic<FwIndexType> m_CommandDroppedQueueOverflowThrottle;
    ...
    private:
      ...
      bool m_first_update_CommandsDispatched = true;

      //! Initialized to true; cleared when channel CommandErrors is first updated
      bool m_first_update_CommandErrors = true;

      //! Initialized to true; cleared when channel CommandsDropped is first updated
      bool m_first_update_CommandsDropped = true;
    ...
    private:
      ...
      //! Records the last emitted value for channel CommandsDropped
      U32 m_last_CommandsDropped = {};
