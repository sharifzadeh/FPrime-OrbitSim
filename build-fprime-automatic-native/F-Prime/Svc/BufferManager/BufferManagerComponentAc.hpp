    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      static constexpr FwIndexType getNum_bufferGetCallee_InputPorts() {
        return NUM_BUFFERGETCALLEE_INPUT_PORTS;
      }
