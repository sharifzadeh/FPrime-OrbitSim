    ...
    public Fw::ActiveComponentBase
  {
    ...
    protected:
      ...
      enum {
        ...
        OPCODE_PRM_LOAD_FILE = 0x1, //!< Loads a file from storage into the staging database. The file could have selective IDs and not the whole set.
        OPCODE_PRM_COMMIT_STAGED = 0x2, //!< Commits the backup database to become the prime (active) database
      };
      ...
      enum {
        ...
        EVENTID_PRMDBCOMMITCOMPLETE = 0x8, //!< Committed staged parameter updates
        EVENTID_PRMDBCOPYALLCOMPLETE = 0x9, //!< All parameters Copied from one DB to another
        EVENTID_PRMDBFILELOADFAILED = 0xa, //!< Parameter file load failed, not staging any update
        EVENTID_PRMDBFILELOADINVALIDACTION = 0xb, //!< Invalid Action during parameter file load
      };
    ...
    protected:
      ...
      virtual void PRM_LOAD_FILE_cmdHandler(
          FwOpcodeType opCode, //!< The opcode
          U32 cmdSeq, //!< The command sequence number
          const Fw::CmdStringArg& fileName, //!< The name of the on-board file to set parameters from
          Svc::PrmDb_Merge merge //!< Whether to merge or fully reset the parameter database from the file contents
      ) = 0;

      //! Handler for command PRM_COMMIT_STAGED
      //!
      //! Commits the backup database to become the prime (active) database
      virtual void PRM_COMMIT_STAGED_cmdHandler(
          FwOpcodeType opCode, //!< The opcode
          U32 cmdSeq //!< The command sequence number
      ) = 0;
    ...
    protected:
      ...
      //!
      //! Loads a file from storage into the staging database. The file could have selective IDs and not the whole set.
      void PRM_LOAD_FILE_cmdHandlerBase(
          FwOpcodeType opCode, //!< The opcode
          U32 cmdSeq, //!< The command sequence number
          Fw::CmdArgBuffer& args //!< The command argument buffer
      );
      ...
      //!
      //! Commits the backup database to become the prime (active) database
      void PRM_COMMIT_STAGED_cmdHandlerBase(
          FwOpcodeType opCode, //!< The opcode
          U32 cmdSeq, //!< The command sequence number
          Fw::CmdArgBuffer& args //!< The command argument buffer
      );
    ...
    protected:
      ...
      virtual void PRM_LOAD_FILE_preMsgHook(
          FwOpcodeType opCode, //!< The opcode
          U32 cmdSeq //!< The command sequence number
      );

      //! Pre-message hook for command PRM_COMMIT_STAGED
      virtual void PRM_COMMIT_STAGED_preMsgHook(
          FwOpcodeType opCode, //!< The opcode
          U32 cmdSeq //!< The command sequence number
      );
    ...
    protected:
      ...
      void log_ACTIVITY_HI_PrmFileLoadComplete(
          const Fw::StringBase& databaseString, //!< The database string
          U32 recordsTotal, //!< The number of records total
          U32 recordsAdded, //!< The number of new records added
          U32 recordsUpdated //!< The number of records updated
      ) const;
      ...
      void log_ACTIVITY_HI_PrmDbCopyAllComplete(
          const Fw::StringBase& databaseStringSrc, //!< The src database string
          const Fw::StringBase& databaseStringDest //!< The dest database string
      ) const;
      ...
      void log_WARNING_LO_PrmDbFileLoadInvalidAction(
          Svc::PrmDb_PrmDbFileLoadState currentState, //!< The current state
          Svc::PrmDb_PrmLoadAction attemptedAction //!< The invalid action attempted
      ) const;
