...
namespace Svc {
    ...
    )
  {
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_bufferSendInFill_InputPorts());
      port++
    ) {
      ...
      Fw::ObjectName portName;
      portName.format(
        "%s_bufferSendInFill_InputPort[%" PRI_FwIndexType "]",
        this->m_objName.toChar(),
        port
      );
      this->m_bufferSendInFill_InputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_bufferSendInReturn_InputPorts());
      port++
    ) {
      ...
      Fw::ObjectName portName;
      portName.format(
        "%s_bufferSendInReturn_InputPort[%" PRI_FwIndexType "]",
        this->m_objName.toChar(),
        port
      );
      this->m_bufferSendInReturn_InputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_eventOutText_OutputPorts());
      port++
    ) {
      ...
      Fw::ObjectName portName;
      portName.format(
        "%s_eventOutText_OutputPort[%" PRI_FwIndexType "]",
        this->m_objName.toChar(),
        port
      );
      this->m_eventOutText_OutputPort[port].setObjName(portName.toChar());
#endif
    }
#endif
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_bufferSendOutDrain_OutputPorts());
      port++
    ) {
      ...
      Fw::ObjectName portName;
      portName.format(
        "%s_bufferSendOutDrain_OutputPort[%" PRI_FwIndexType "]",
        this->m_objName.toChar(),
        port
      );
      this->m_bufferSendOutDrain_OutputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_bufferSendOutReturn_OutputPorts());
      port++
    ) {
      ...
      Fw::ObjectName portName;
      portName.format(
        "%s_bufferSendOutReturn_OutputPort[%" PRI_FwIndexType "]",
        this->m_objName.toChar(),
        port
      );
      this->m_bufferSendOutReturn_OutputPort[port].setObjName(portName.toChar());
#endif
    }
  ...
  Fw::InputBufferSendPort* BufferAccumulatorComponentBase ::
    get_bufferSendInFill_InputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_bufferSendInFill_InputPorts()),
      static_cast<FwAssertArgType>(portNum)
    );
  ...
  Fw::InputBufferSendPort* BufferAccumulatorComponentBase ::
    get_bufferSendInReturn_InputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_bufferSendInReturn_InputPorts()),
      static_cast<FwAssertArgType>(portNum)
    );
  ...
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_eventOutText_OutputPorts()),
      static_cast<FwAssertArgType>(portNum)
    );
  ...
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_bufferSendOutDrain_OutputPorts()),
      static_cast<FwAssertArgType>(portNum)
    );
  ...
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_bufferSendOutReturn_OutputPorts()),
      static_cast<FwAssertArgType>(portNum)
    );
  ...
  bool BufferAccumulatorComponentBase ::
    isConnected_eventOutText_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_eventOutText_OutputPorts()),
      static_cast<FwAssertArgType>(portNum)
  ...
  bool BufferAccumulatorComponentBase ::
    isConnected_bufferSendOutDrain_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_bufferSendOutDrain_OutputPorts()),
      static_cast<FwAssertArgType>(portNum)
  ...
  bool BufferAccumulatorComponentBase ::
    isConnected_bufferSendOutReturn_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      (0 <= portNum) && (portNum < this->getNum_bufferSendOutReturn_OutputPorts()),
      static_cast<FwAssertArgType>(portNum)
    ...
    )
  {
    ...
    _status = msg.serializeFrom(
      static_cast<FwEnumStoreType>(BUFFERSENDINFILL_BUFFERSEND)
    );
    FW_ASSERT(
    ...
    )
  {
    ...
    // Serialize message ID
    _status = msg.serializeFrom(
      static_cast<FwEnumStoreType>(BUFFERSENDINRETURN_BUFFERSEND)
    );
    FW_ASSERT(
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    ...
    )
  {
    ...
    FW_ASSERT(
      this->m_bufferSendOutDrain_OutputPort[portNum].isConnected(),
      static_cast<FwAssertArgType>(portNum)
    );
    ...
    )
  {
    ...
    FW_ASSERT(
      this->m_bufferSendOutReturn_OutputPort[portNum].isConnected(),
      static_cast<FwAssertArgType>(portNum)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serializeFrom(static_cast<FwEnumStoreType>(CMD_BA_SETMODE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serializeFrom(static_cast<FwEnumStoreType>(CMD_BA_DRAINBUFFERS));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
  ...
  void BufferAccumulatorComponentBase ::
    log_ACTIVITY_HI_BA_BufferAccepted() const
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void BufferAccumulatorComponentBase ::
    log_WARNING_HI_BA_QueueFull() const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
...
#endif
      _status = _logBuff.serializeFrom(numDrained);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
      _status = _logBuff.serializeFrom(numToDrain);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
  ...
  void BufferAccumulatorComponentBase ::
    log_WARNING_HI_BA_AlreadyDraining() const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void BufferAccumulatorComponentBase ::
    log_ACTIVITY_HI_BA_PartialDrainDone(U32 numDrained) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
...
#endif
      _status = _logBuff.serializeFrom(numWillDrain);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
...
#endif
      _status = _logBuff.serializeFrom(numReqDrain);
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
    ...
    doDispatch()
  {
    ...
    if (_msgType == BUFFERACCUMULATOR_COMPONENT_EXIT) {
    ...
    switch (_msgType) {
      ...
      case CMD_BA_SETMODE: {
        ...
        _deserStatus = args.deserializeTo(mode);
      ...
      case CMD_BA_DRAINBUFFERS: {
        ...
        U32 numToDrain;
        _deserStatus = args.deserializeTo(numToDrain);
        if (_deserStatus != Fw::FW_SERIALIZE_OK) {
          if (this->m_cmdResponseOut_OutputPort[0].isConnected()) {
            this->cmdResponse_out(
                _opCode,
        ...
        _deserStatus = args.deserializeTo(blockMode);
        if (_deserStatus != Fw::FW_SERIALIZE_OK) {
          if (this->m_cmdResponseOut_OutputPort[0].isConnected()) {
            this->cmdResponse_out(
                _opCode,
