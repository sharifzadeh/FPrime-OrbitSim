// ======================================================================
// \title  AsyncByteStreamBufferAdapterComponentAc.hpp
// \author Generated by fpp-to-cpp
// \brief  hpp file for AsyncByteStreamBufferAdapter component base class
// ======================================================================

#ifndef Drv_AsyncByteStreamBufferAdapterComponentAc_HPP
#define Drv_AsyncByteStreamBufferAdapterComponentAc_HPP
...
namespace Drv {
  ...
  //! \class AsyncByteStreamBufferAdapterComponentBase
  //! \brief Auto-generated base for AsyncByteStreamBufferAdapter component
  //!
    ...
    public Fw::PassiveComponentBase
  {
      ...
      friend class AsyncByteStreamBufferAdapterTesterBase;
      //! Friend class tester implementation to support white-box testing
      friend class AsyncByteStreamBufferAdapterTester;
    ...
    protected:
      ...
      enum {
        ...
        NUM_TOBYTESTREAMDRIVERRETURN_INPUT_PORTS = 1,
      };
    ...
    public:
      ...
      //! Initialize AsyncByteStreamBufferAdapterComponentBase object
      void init(
    ...
    public:
      ...
      //! Get typed input port at index
      //!
      //! \return toByteStreamDriverReturn[portNum]
      Drv::InputByteStreamDataPort* get_toByteStreamDriverReturn_InputPort(
          FwIndexType portNum //!< The port number
      );
    ...
    protected:
      ...
      //! Construct AsyncByteStreamBufferAdapterComponentBase object
      AsyncByteStreamBufferAdapterComponentBase(
          const char* compName = "" //!< The component name
      );

      //! Destroy AsyncByteStreamBufferAdapterComponentBase object
      virtual ~AsyncByteStreamBufferAdapterComponentBase();
    ...
    protected:
      ...
      //! Get the number of toByteStreamDriverReturn input ports
      //!
      //! \return The number of toByteStreamDriverReturn input ports
      static constexpr FwIndexType getNum_toByteStreamDriverReturn_InputPorts() {
        return NUM_TOBYTESTREAMDRIVERRETURN_INPUT_PORTS;
      }
    ...
    protected:
      ...
      //! Handler for input port toByteStreamDriverReturn
      virtual void toByteStreamDriverReturn_handler(
          FwIndexType portNum, //!< The port number
          Fw::Buffer& buffer,
          const Drv::ByteStreamStatus& status
      ) = 0;
    ...
    protected:
      ...
      //! Handler base-class function for input port toByteStreamDriverReturn
      void toByteStreamDriverReturn_handlerBase(
          FwIndexType portNum, //!< The port number
          Fw::Buffer& buffer,
          const Drv::ByteStreamStatus& status
      );
    ...
    private:
      ...
      //! Callback for port toByteStreamDriverReturn
      static void m_p_toByteStreamDriverReturn_in(
          Fw::PassiveComponentBase* callComp, //!< The component instance
          FwIndexType portNum, //!< The port number
          Fw::Buffer& buffer,
          const Drv::ByteStreamStatus& status
    ...
    private:
      ...
      //! Input port toByteStreamDriverReturn
      Drv::InputByteStreamDataPort m_toByteStreamDriverReturn_InputPort[NUM_TOBYTESTREAMDRIVERRETURN_INPUT_PORTS];
    ...
    private:
      ...
      Fw::OutputBufferSendPort m_toByteStreamDriver_OutputPort[NUM_TOBYTESTREAMDRIVER_OUTPUT_PORTS];
